...
function Leeroy()	
	...
	surface.SetTexture(surface.GetTextureID("gui/sledbuild_classic/timer_bg2"))
	...
	local slbclocky = 136
	local slbclockz = 0.6
	surface.SetTexture(surface.GetTextureID("gui/sledbuild_classic/timer_bg"))
	...
	surface.SetTexture(surface.GetTextureID("gui/sledbuild_classic/timer_ro"))
	...
	surface.SetTexture(surface.GetTextureID("gui/sledbuild_classic/timer_sh"))
	...
	// Player Name
	draw.DrawText("Имя: " .. Name,"ScoreboardText",13,10,Color(255, 255, 255, 255),0,0)

	// Stats
	draw.DrawText("Тройка лучших " .. Won .. " из " .. Won + Lost .. " гонок","ScoreboardText",13,30,Color(255, 255, 255, 255),0,0)

	// Building Racing
	draw.DrawText("Гонка: " .. HowManyRacing .. " из " .. TotalPlayers .." игроков","ScoreboardText",13,50,Color(255, 255, 255, 255),0,0)

	// Last Race Title
	draw.DrawText("Гонка #" ..HM.. " Релультаты::","ScoreboardText",13,70,Color(255, 255, 255, 255),0,0)

	// Last Race Stats
	draw.DrawText("1-место: " .. FirstPosition,"ScoreboardText",13, 90,Color(0, 255, 0, 255),0,0)
	draw.DrawText("2-место: " .. SecondPosition,"ScoreboardText",13, 110,Color(255, 255, 0, 255),0,0)
	draw.DrawText("3-место: " .. ThirdPosition,"ScoreboardText",13, 130,Color(255, 0, 0, 255),0,0)
