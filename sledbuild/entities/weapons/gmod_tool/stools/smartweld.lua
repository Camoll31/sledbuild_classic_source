...
if CLIENT then
	...
	language.Add("tool.smartweld.name", "Умная сварка")
	language.Add("tool.smartweld.desc", "Автоматически сваривает выбранные пропы")

	language.Add("tool.smartweld.left", "Выберите или отмените выбор пропа.")
	language.Add("tool.smartweld.leftuse", "Автоматически выбирает проп в заданном радиусе.")
	language.Add("tool.smartweld.right", "Сваривает выбранный проп.")
	language.Add("tool.smartweld.rightuse", "Приваривает все реквизиты к тому, на что вы смотрите.")
	language.Add("tool.smartweld.reload", "Очищает текущий выбор.")
